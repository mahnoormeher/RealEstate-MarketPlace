...
<span className="text-xs">($ / month)</span>
        ...
        <div className="flex flex-col flex-1 gap-4">
            <p className="font-semibold text-blue-900">Images:
...
<button className="p-3 text-blue-800 border border-blue-800 rounded uppercase hover:shadow-lg disabled:opacity-80">Upload</button>
            </div>
